...
func _prepare_game() -> void:
	...
	current_minigame_node.get_node("base_minigame").z_index = 0
	previous_minigame_node.get_node("base_minigame").z_index = 1
	next_minigame_node.get_node("base_minigame").z_index = 1
